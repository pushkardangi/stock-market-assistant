...
function Average() {
    ...
    const calcAvg = (event) => {
        ...
        let average = document.getElementById("stockVal").value;
  ...
  return (
    <>
      <div>
          ...
          <div
            className="p-2 my-8 unselectable cursor-pointer flex w-full justify-center bg-green-400 hover:bg-green-500 text-white font-medium rounded" onClick={calcAvg}>
