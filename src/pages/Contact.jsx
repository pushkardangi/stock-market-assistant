  ...
  return (
    <div>
       <div className="flex h-screen bg-purple-400">
        <div className="w-1/2 m-auto rounded-md">
         ...
         <div className="my-2">
         <button type="button" class="min-w-full text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-300">
              Send Message
